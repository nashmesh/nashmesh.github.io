...
<div class="dc-preview">
  <div class="dc-message">
    ...
    <div class="dc-content">
      ...
      <div class="dc-body"><span class="dc-cmd">!mqtt</span></div>
    </div>
  </div>
    ...
    <div class="dc-content">
      ...
      <div class="dc-embeds">
        <div class="dc-embed">
          <div class="dc-embed-pill"></div>
          <div class="dc-embed-body">
            <div class="dc-embed-title">MeshCore MQTT Details</div>
            <div class="dc-embed-fields">
              <div class="dc-field--1">
                <div class="dc-field-name">MQTT Host</div>
                <div class="dc-field-value">mqtt.nashme.sh</div>
              </div>
              <div class="dc-field--1">
                <div class="dc-field-name">MQTT Username</div>
                <div class="dc-field-value">meshdev</div>
              </div>
              <div class="dc-field--1">
                <div class="dc-field-name">MQTT Password</div>
                <div class="dc-field-value">large4cats</div>
              </div>
              <div class="dc-field--1">
                <div class="dc-field-name">Read More</div>
                <div class="dc-field-value"><a href="https://nashme.sh/mqtt">nashme.sh/mqtt</a></div>
              </div>
            </div>
          </div>
        </div>
        <div class="dc-embed">
          <div class="dc-embed-pill"></div>
          <div class="dc-embed-body">
            <div class="dc-embed-title">Meshtastic MQTT Details</div>
            <div class="dc-embed-fields">
              <div class="dc-field--1">
                <div class="dc-field-name">MQTT Host</div>
                <div class="dc-field-value">mqtt.nashme.sh</div>
              ...
              <div class="dc-field">
                <div class="dc-field-name"><code>Primary</code> Channel Uplink</div>
                <div class="dc-field-value">enabled</div>
              </div>
              <div class="dc-field">
                <div class="dc-field-name">OK to MQTT</div>
                <div class="dc-field-value">enabled</div>
              </div>
              <div class="dc-field--1">
                <div class="dc-field-name">Topic</div>
                <div class="dc-field-value">msh/US/TN/Middle</div>
              </div>
              <div class="dc-field--1">
                <div class="dc-field-name">Read More</div>
                <div class="dc-field-value"><a href="https://nashme.sh/mqtt">nashme.sh/mqtt</a></div>
