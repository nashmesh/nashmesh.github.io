...
Below are nodes that have an average SNR of ≥ -50dB or more (over a 48hr period). Data for this table is pulled from [here](https://malla.nashme.sh/traceroute-graph).
